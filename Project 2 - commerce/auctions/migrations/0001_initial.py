    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid_type', models.CharField(default='BID', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_bid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='auctions.bid')),
        ...
        migrations.AddField(
            model_name='user',
            name='watchlist',
            field=models.ManyToManyField(blank=True, related_name='potential_buyers', to='auctions.listing'),
        ),
    ]
